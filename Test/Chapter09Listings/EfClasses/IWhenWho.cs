...
namespace Test.Chapter09Listings.EfClasses
{
    ...
    #B These two properties hold the UserId who created the original entity, and when that happened
    #C These two properties hold the UserId who updated the entity, and when that happened
